...
echo "   docker run -p 8080:8080 19ec2f3f-00b0-4b4f-b0a8-f609ba639794"
echo
...
if [[ $RUNDOCKER =~ ^[Yy]$ ]]; then
  ...
  docker run -d -p 8080:8080 --name 19ec2f3f-00b0-4b4f-b0a8-f609ba639794 19ec2f3f-00b0-4b4f-b0a8-f609ba639794
  echo
