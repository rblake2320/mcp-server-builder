/**
 * DocGen MCP Server: next.js
 * 
 * This MCP server provides access to next.js documentation and code snippets.
 * It allows AI assistants to search, retrieve, and use documentation and
 * code examples from vercel/next.js.
 * 
...
const CODE_SNIPPETS = [
  {
    "title": "Example 1",
    "code": "// Example 1 for next.js\nconst next.js = require('next.js');\n\nfunction example1() {\n  // Function implementation\n  return next.js.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 2",
    "code": "// Example 2 for next.js\nconst next.js = require('next.js');\n\nfunction example2() {\n  // Function implementation\n  return next.js.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 3",
    "code": "# Example 3 for next.js\nimport next.js\n\ndef example3():\n    # Function implementation\n    return next.js.do_something()",
    "language": "python"
  },
  {
    "title": "Example 4",
    "code": "// Example 4 for next.js\nconst next.js = require('next.js');\n\nfunction example4() {\n  // Function implementation\n  return next.js.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 5",
    "code": "// Example 5 for next.js\nconst next.js = require('next.js');\n\nfunction example5() {\n  // Function implementation\n  return next.js.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 6",
    "code": "# Example 6 for next.js\nimport next.js\n\ndef example6():\n    # Function implementation\n    return next.js.do_something()",
    "language": "python"
  },
  {
    "title": "Example 7",
    "code": "// Example 7 for next.js\nconst next.js = require('next.js');\n\nfunction example7() {\n  // Function implementation\n  return next.js.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 8",
    "code": "// Example 8 for next.js\nconst next.js = require('next.js');\n\nfunction example8() {\n  // Function implementation\n  return next.js.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 9",
    "code": "# Example 9 for next.js\nimport next.js\n\ndef example9():\n    # Function implementation\n    return next.js.do_something()",
    "language": "python"
  },
  {
    "title": "Example 10",
    "code": "// Example 10 for next.js\nconst next.js = require('next.js');\n\nfunction example10() {\n  // Function implementation\n  return next.js.doSomething();\n}",
    "language": "javascript"
  }
];
...
const TOOLS = [
  {
    name: 'search_docs',
    description: 'Search the next.js documentation',
    parameters: {
      type: 'object',
      properties: {
        query: {
  ...
  },
  {
    ...
    description: 'Get code examples from the next.js documentation',
    parameters: {
      type: 'object',
      properties: {
        keyword: {
...
app.get('/', (req, res) => {
  res.json({
    name: 'next.js Documentation Server',
    description: 'An MCP server providing access to next.js documentation',
    version: '1.0.0',
    protocol: 'mcp',
...
app.listen(PORT, () => {
  console.log(`next.js Documentation Server running on port ${PORT}`);
});
