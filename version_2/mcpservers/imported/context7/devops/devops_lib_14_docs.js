/**
 * DocGen MCP Server: devops-lib-14
 * 
 * This MCP server provides access to devops-lib-14 documentation and code snippets.
 * It allows AI assistants to search, retrieve, and use documentation and
 * code examples from example-org/devops-lib-14.
 * 
...
const DOC_DATA = {
  "name": "devops-lib-14",
  "owner": "example-org",
  "repo": "example-org/devops-lib-14",
  "sections": [
    {
      "title": "Introduction"
    },
  ...
  "metadata": {
    "language": "javascript",
    "version": "3.7.9",
    "lastUpdate": "2025-04-27T01:40:40.607Z"
  }
};
...
const SECTIONS = [
  {
    "title": "Introduction",
    "content": "# devops-lib-14\n\nThis is the documentation for devops-lib-14. It provides an overview of key features and how to use them.\n\n## Installation\n\n```bash\nnpm install devops-lib-14\n```\n\n## Getting Started\n\nHere's a simple example to get started:"
  },
  {
    "title": "API Reference",
    "content": "# API Reference\n\nThis section documents the devops-lib-14 API.\n\n## Core APIs\n\nThe core functionality is exposed through these main functions and classes.\n\n### `function1(param1, param2)`\n\nDescription of function1 and its parameters.\n\n### `class Class1`\n\nDescription of Class1 and its methods."
  },
  {
    "title": "Examples",
    "content": "# Examples\n\nHere are some examples of common use cases for devops-lib-14.\n\n## Basic Example\n\n```javascript\n// Example code here\n```\n\n## Advanced Example\n\n```javascript\n// Advanced example code here\n```"
  },
  {
    "title": "FAQ",
    "content": "# Frequently Asked Questions\n\n## How do I install devops-lib-14?\n\nYou can install devops-lib-14 using npm or yarn.\n\n## How do I contribute to devops-lib-14?\n\nContributions are welcome! Please read our contribution guidelines."
  }
];
...
const CODE_SNIPPETS = [
  {
    "title": "Example 1",
    "code": "// Example 1 for devops-lib-14\nconst devops-lib-14 = require('devops-lib-14');\n\nfunction example1() {\n  // Function implementation\n  return devops-lib-14.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 2",
    "code": "// Example 2 for devops-lib-14\nconst devops-lib-14 = require('devops-lib-14');\n\nfunction example2() {\n  // Function implementation\n  return devops-lib-14.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 3",
    "code": "# Example 3 for devops-lib-14\nimport devops-lib-14\n\ndef example3():\n    # Function implementation\n    return devops-lib-14.do_something()",
    "language": "python"
  },
  {
    "title": "Example 4",
    "code": "// Example 4 for devops-lib-14\nconst devops-lib-14 = require('devops-lib-14');\n\nfunction example4() {\n  // Function implementation\n  return devops-lib-14.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 5",
    "code": "// Example 5 for devops-lib-14\nconst devops-lib-14 = require('devops-lib-14');\n\nfunction example5() {\n  // Function implementation\n  return devops-lib-14.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 6",
    "code": "# Example 6 for devops-lib-14\nimport devops-lib-14\n\ndef example6():\n    # Function implementation\n    return devops-lib-14.do_something()",
    "language": "python"
  },
  {
    "title": "Example 7",
    "code": "// Example 7 for devops-lib-14\nconst devops-lib-14 = require('devops-lib-14');\n\nfunction example7() {\n  // Function implementation\n  return devops-lib-14.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 8",
    "code": "// Example 8 for devops-lib-14\nconst devops-lib-14 = require('devops-lib-14');\n\nfunction example8() {\n  // Function implementation\n  return devops-lib-14.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 9",
    "code": "# Example 9 for devops-lib-14\nimport devops-lib-14\n\ndef example9():\n    # Function implementation\n    return devops-lib-14.do_something()",
    "language": "python"
  },
  {
    "title": "Example 10",
    "code": "// Example 10 for devops-lib-14\nconst devops-lib-14 = require('devops-lib-14');\n\nfunction example10() {\n  // Function implementation\n  return devops-lib-14.doSomething();\n}",
    "language": "javascript"
  }
];
...
const TOOLS = [
  {
    name: 'search_docs',
    description: 'Search the devops-lib-14 documentation',
    parameters: {
      type: 'object',
      properties: {
        query: {
  ...
  },
  {
    ...
    description: 'Get code examples from the devops-lib-14 documentation',
    parameters: {
      type: 'object',
      properties: {
        keyword: {
...
app.get('/', (req, res) => {
  res.json({
    name: 'devops-lib-14 Documentation Server',
    description: 'An MCP server providing access to devops-lib-14 documentation',
    version: '1.0.0',
    protocol: 'mcp',
    protocol_version: MCP_PROTOCOL_VERSION,
    source: 'Context7',
    repository: 'example-org/devops-lib-14',
...
app.listen(PORT, () => {
  console.log(`devops-lib-14 Documentation Server running on port ${PORT}`);
});
