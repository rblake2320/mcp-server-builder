/**
 * DocGen MCP Server: fastapi
 * 
 * This MCP server provides access to fastapi documentation and code snippets.
 * It allows AI assistants to search, retrieve, and use documentation and
 * code examples from tiangolo/fastapi.
 * 
...
const DOC_DATA = {
  ...
  "metadata": {
    "language": "javascript",
    "version": "1.0.6",
    "lastUpdate": "2025-04-27T01:39:26.471Z"
  }
};
...
const CODE_SNIPPETS = [
  {
    "title": "Example 1",
    "code": "// Example 1 for fastapi\nconst fastapi = require('fastapi');\n\nfunction example1() {\n  // Function implementation\n  return fastapi.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 2",
    "code": "// Example 2 for fastapi\nconst fastapi = require('fastapi');\n\nfunction example2() {\n  // Function implementation\n  return fastapi.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 3",
    "code": "# Example 3 for fastapi\nimport fastapi\n\ndef example3():\n    # Function implementation\n    return fastapi.do_something()",
    "language": "python"
  },
  {
    "title": "Example 4",
    "code": "// Example 4 for fastapi\nconst fastapi = require('fastapi');\n\nfunction example4() {\n  // Function implementation\n  return fastapi.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 5",
    "code": "// Example 5 for fastapi\nconst fastapi = require('fastapi');\n\nfunction example5() {\n  // Function implementation\n  return fastapi.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 6",
    "code": "# Example 6 for fastapi\nimport fastapi\n\ndef example6():\n    # Function implementation\n    return fastapi.do_something()",
    "language": "python"
  },
  {
    "title": "Example 7",
    "code": "// Example 7 for fastapi\nconst fastapi = require('fastapi');\n\nfunction example7() {\n  // Function implementation\n  return fastapi.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 8",
    "code": "// Example 8 for fastapi\nconst fastapi = require('fastapi');\n\nfunction example8() {\n  // Function implementation\n  return fastapi.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 9",
    "code": "# Example 9 for fastapi\nimport fastapi\n\ndef example9():\n    # Function implementation\n    return fastapi.do_something()",
    "language": "python"
  },
  {
    "title": "Example 10",
    "code": "// Example 10 for fastapi\nconst fastapi = require('fastapi');\n\nfunction example10() {\n  // Function implementation\n  return fastapi.doSomething();\n}",
    "language": "javascript"
  }
];
...
const TOOLS = [
  {
    name: 'search_docs',
    description: 'Search the fastapi documentation',
    parameters: {
      type: 'object',
      properties: {
        query: {
  ...
  },
  {
    ...
    description: 'Get code examples from the fastapi documentation',
    parameters: {
      type: 'object',
      properties: {
        keyword: {
...
app.get('/', (req, res) => {
  res.json({
    ...
    description: 'An MCP server providing access to fastapi documentation',
    version: '1.0.0',
    protocol: 'mcp',
...
app.listen(PORT, () => {
  console.log(`fastapi Documentation Server running on port ${PORT}`);
});
