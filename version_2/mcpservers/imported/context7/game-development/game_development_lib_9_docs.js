/**
 * DocGen MCP Server: game-development-lib-9
 * 
 * This MCP server provides access to game-development-lib-9 documentation and code snippets.
 * It allows AI assistants to search, retrieve, and use documentation and
 * code examples from example-org/game-development-lib-9.
 * 
...
// Documentation data
const DOC_DATA = {
  "name": "game-development-lib-9",
  "owner": "example-org",
  "repo": "example-org/game-development-lib-9",
  "sections": [
    {
      "title": "Introduction"
    },
  ...
  "metadata": {
    "language": "javascript",
    "version": "6.8.8",
    "lastUpdate": "2025-04-27T01:40:39.100Z"
  }
};
...
const SECTIONS = [
  {
    "title": "Introduction",
    "content": "# game-development-lib-9\n\nThis is the documentation for game-development-lib-9. It provides an overview of key features and how to use them.\n\n## Installation\n\n```bash\nnpm install game-development-lib-9\n```\n\n## Getting Started\n\nHere's a simple example to get started:"
  },
  {
    "title": "API Reference",
    "content": "# API Reference\n\nThis section documents the game-development-lib-9 API.\n\n## Core APIs\n\nThe core functionality is exposed through these main functions and classes.\n\n### `function1(param1, param2)`\n\nDescription of function1 and its parameters.\n\n### `class Class1`\n\nDescription of Class1 and its methods."
  },
  {
    "title": "Examples",
    "content": "# Examples\n\nHere are some examples of common use cases for game-development-lib-9.\n\n## Basic Example\n\n```javascript\n// Example code here\n```\n\n## Advanced Example\n\n```javascript\n// Advanced example code here\n```"
  },
  {
    "title": "FAQ",
    "content": "# Frequently Asked Questions\n\n## How do I install game-development-lib-9?\n\nYou can install game-development-lib-9 using npm or yarn.\n\n## How do I contribute to game-development-lib-9?\n\nContributions are welcome! Please read our contribution guidelines."
  }
];
...
const CODE_SNIPPETS = [
  {
    "title": "Example 1",
    "code": "// Example 1 for game-development-lib-9\nconst game-development-lib-9 = require('game-development-lib-9');\n\nfunction example1() {\n  // Function implementation\n  return game-development-lib-9.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 2",
    "code": "// Example 2 for game-development-lib-9\nconst game-development-lib-9 = require('game-development-lib-9');\n\nfunction example2() {\n  // Function implementation\n  return game-development-lib-9.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 3",
    "code": "# Example 3 for game-development-lib-9\nimport game-development-lib-9\n\ndef example3():\n    # Function implementation\n    return game-development-lib-9.do_something()",
    "language": "python"
  },
  {
    "title": "Example 4",
    "code": "// Example 4 for game-development-lib-9\nconst game-development-lib-9 = require('game-development-lib-9');\n\nfunction example4() {\n  // Function implementation\n  return game-development-lib-9.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 5",
    "code": "// Example 5 for game-development-lib-9\nconst game-development-lib-9 = require('game-development-lib-9');\n\nfunction example5() {\n  // Function implementation\n  return game-development-lib-9.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 6",
    "code": "# Example 6 for game-development-lib-9\nimport game-development-lib-9\n\ndef example6():\n    # Function implementation\n    return game-development-lib-9.do_something()",
    "language": "python"
  },
  {
    "title": "Example 7",
    "code": "// Example 7 for game-development-lib-9\nconst game-development-lib-9 = require('game-development-lib-9');\n\nfunction example7() {\n  // Function implementation\n  return game-development-lib-9.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 8",
    "code": "// Example 8 for game-development-lib-9\nconst game-development-lib-9 = require('game-development-lib-9');\n\nfunction example8() {\n  // Function implementation\n  return game-development-lib-9.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 9",
    "code": "# Example 9 for game-development-lib-9\nimport game-development-lib-9\n\ndef example9():\n    # Function implementation\n    return game-development-lib-9.do_something()",
    "language": "python"
  },
  {
    "title": "Example 10",
    "code": "// Example 10 for game-development-lib-9\nconst game-development-lib-9 = require('game-development-lib-9');\n\nfunction example10() {\n  // Function implementation\n  return game-development-lib-9.doSomething();\n}",
    "language": "javascript"
  }
];
...
const TOOLS = [
  {
    name: 'search_docs',
    description: 'Search the game-development-lib-9 documentation',
    parameters: {
      type: 'object',
      properties: {
        query: {
  ...
  },
  {
    ...
    description: 'Get code examples from the game-development-lib-9 documentation',
    parameters: {
      type: 'object',
      properties: {
        keyword: {
...
app.get('/', (req, res) => {
  res.json({
    name: 'game-development-lib-9 Documentation Server',
    description: 'An MCP server providing access to game-development-lib-9 documentation',
    version: '1.0.0',
    protocol: 'mcp',
    protocol_version: MCP_PROTOCOL_VERSION,
    source: 'Context7',
    repository: 'example-org/game-development-lib-9',
...
app.listen(PORT, () => {
  console.log(`game-development-lib-9 Documentation Server running on port ${PORT}`);
});
