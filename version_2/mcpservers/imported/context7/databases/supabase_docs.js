/**
 * DocGen MCP Server: supabase
 * 
 * This MCP server provides access to supabase documentation and code snippets.
 * It allows AI assistants to search, retrieve, and use documentation and
 * code examples from supabase/supabase.
 * 
...
const DOC_DATA = {
  ...
  "metadata": {
    "language": "javascript",
    "version": "1.4.7",
    "lastUpdate": "2025-04-27T01:40:36.384Z"
  }
};
...
const CODE_SNIPPETS = [
  {
    "title": "Example 1",
    "code": "// Example 1 for supabase\nconst supabase = require('supabase');\n\nfunction example1() {\n  // Function implementation\n  return supabase.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 2",
    "code": "// Example 2 for supabase\nconst supabase = require('supabase');\n\nfunction example2() {\n  // Function implementation\n  return supabase.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 3",
    "code": "# Example 3 for supabase\nimport supabase\n\ndef example3():\n    # Function implementation\n    return supabase.do_something()",
    "language": "python"
  },
  {
    "title": "Example 4",
    "code": "// Example 4 for supabase\nconst supabase = require('supabase');\n\nfunction example4() {\n  // Function implementation\n  return supabase.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 5",
    "code": "// Example 5 for supabase\nconst supabase = require('supabase');\n\nfunction example5() {\n  // Function implementation\n  return supabase.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 6",
    "code": "# Example 6 for supabase\nimport supabase\n\ndef example6():\n    # Function implementation\n    return supabase.do_something()",
    "language": "python"
  },
  {
    "title": "Example 7",
    "code": "// Example 7 for supabase\nconst supabase = require('supabase');\n\nfunction example7() {\n  // Function implementation\n  return supabase.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 8",
    "code": "// Example 8 for supabase\nconst supabase = require('supabase');\n\nfunction example8() {\n  // Function implementation\n  return supabase.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 9",
    "code": "# Example 9 for supabase\nimport supabase\n\ndef example9():\n    # Function implementation\n    return supabase.do_something()",
    "language": "python"
  },
  {
    "title": "Example 10",
    "code": "// Example 10 for supabase\nconst supabase = require('supabase');\n\nfunction example10() {\n  // Function implementation\n  return supabase.doSomething();\n}",
    "language": "javascript"
  }
];
...
const TOOLS = [
  ...
  },
  {
    ...
    description: 'Get code examples from the supabase documentation',
    parameters: {
      type: 'object',
      properties: {
        keyword: {
...
app.get('/', (req, res) => {
  res.json({
    name: 'supabase Documentation Server',
    description: 'An MCP server providing access to supabase documentation',
    version: '1.0.0',
    protocol: 'mcp',
...
app.listen(PORT, () => {
  console.log(`supabase Documentation Server running on port ${PORT}`);
});
