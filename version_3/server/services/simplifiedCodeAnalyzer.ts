...
// Simple metrics without relying on D3 visualization
...
/**
 * Analyzes code complexity for MCP server functions without D3 visualization
 */
export async function analyzeCode(code: string): Promise<SimpleAnalysisResult> {
  try {
    // Parse code
