/**
 * DocGen MCP Server: elasticsearch
 * 
 * This MCP server provides access to elasticsearch documentation and code snippets.
 * It allows AI assistants to search, retrieve, and use documentation and
 * code examples from elastic/elasticsearch.
 * 
...
const DOC_DATA = {
  ...
  "metadata": {
    "language": "javascript",
    "version": "1.9.0",
    "lastUpdate": "2025-04-27T01:39:24.963Z"
  }
};
...
const CODE_SNIPPETS = [
  {
    "title": "Example 1",
    "code": "// Example 1 for elasticsearch\nconst elasticsearch = require('elasticsearch');\n\nfunction example1() {\n  // Function implementation\n  return elasticsearch.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 2",
    "code": "// Example 2 for elasticsearch\nconst elasticsearch = require('elasticsearch');\n\nfunction example2() {\n  // Function implementation\n  return elasticsearch.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 3",
    "code": "# Example 3 for elasticsearch\nimport elasticsearch\n\ndef example3():\n    # Function implementation\n    return elasticsearch.do_something()",
    "language": "python"
  },
  {
    "title": "Example 4",
    "code": "// Example 4 for elasticsearch\nconst elasticsearch = require('elasticsearch');\n\nfunction example4() {\n  // Function implementation\n  return elasticsearch.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 5",
    "code": "// Example 5 for elasticsearch\nconst elasticsearch = require('elasticsearch');\n\nfunction example5() {\n  // Function implementation\n  return elasticsearch.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 6",
    "code": "# Example 6 for elasticsearch\nimport elasticsearch\n\ndef example6():\n    # Function implementation\n    return elasticsearch.do_something()",
    "language": "python"
  },
  {
    "title": "Example 7",
    "code": "// Example 7 for elasticsearch\nconst elasticsearch = require('elasticsearch');\n\nfunction example7() {\n  // Function implementation\n  return elasticsearch.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 8",
    "code": "// Example 8 for elasticsearch\nconst elasticsearch = require('elasticsearch');\n\nfunction example8() {\n  // Function implementation\n  return elasticsearch.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 9",
    "code": "# Example 9 for elasticsearch\nimport elasticsearch\n\ndef example9():\n    # Function implementation\n    return elasticsearch.do_something()",
    "language": "python"
  },
  {
    "title": "Example 10",
    "code": "// Example 10 for elasticsearch\nconst elasticsearch = require('elasticsearch');\n\nfunction example10() {\n  // Function implementation\n  return elasticsearch.doSomething();\n}",
    "language": "javascript"
  }
];
...
const TOOLS = [
  {
    name: 'search_docs',
    description: 'Search the elasticsearch documentation',
    parameters: {
      type: 'object',
      properties: {
        query: {
  ...
  },
  {
    ...
    description: 'Get code examples from the elasticsearch documentation',
    parameters: {
      type: 'object',
      properties: {
        keyword: {
...
app.get('/', (req, res) => {
  res.json({
    name: 'elasticsearch Documentation Server',
    description: 'An MCP server providing access to elasticsearch documentation',
    version: '1.0.0',
    protocol: 'mcp',
...
app.listen(PORT, () => {
  console.log(`elasticsearch Documentation Server running on port ${PORT}`);
});
