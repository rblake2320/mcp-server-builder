/**
 * DocGen MCP Server: tutorials
 * 
 * This MCP server provides access to tutorials documentation and code snippets.
 * It allows AI assistants to search, retrieve, and use documentation and
 * code examples from pytorch/tutorials.
 * 
...
const DOC_DATA = {
  ...
  "metadata": {
    "language": "javascript",
    "version": "8.7.0",
    "lastUpdate": "2025-04-27T01:39:26.772Z"
  }
};
...
const SECTIONS = [
  {
    "title": "Introduction",
    "content": "# tutorials\n\nThis is the documentation for tutorials. It provides an overview of key features and how to use them.\n\n## Installation\n\n```bash\nnpm install tutorials\n```\n\n## Getting Started\n\nHere's a simple example to get started:"
  },
  {
    "title": "API Reference",
    "content": "# API Reference\n\nThis section documents the tutorials API.\n\n## Core APIs\n\nThe core functionality is exposed through these main functions and classes.\n\n### `function1(param1, param2)`\n\nDescription of function1 and its parameters.\n\n### `class Class1`\n\nDescription of Class1 and its methods."
  },
  {
    "title": "Examples",
    "content": "# Examples\n\nHere are some examples of common use cases for tutorials.\n\n## Basic Example\n\n```javascript\n// Example code here\n```\n\n## Advanced Example\n\n```javascript\n// Advanced example code here\n```"
  },
  {
    "title": "FAQ",
    "content": "# Frequently Asked Questions\n\n## How do I install tutorials?\n\nYou can install tutorials using npm or yarn.\n\n## How do I contribute to tutorials?\n\nContributions are welcome! Please read our contribution guidelines."
  }
];
...
const CODE_SNIPPETS = [
  {
    "title": "Example 1",
    "code": "// Example 1 for tutorials\nconst tutorials = require('tutorials');\n\nfunction example1() {\n  // Function implementation\n  return tutorials.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 2",
    "code": "// Example 2 for tutorials\nconst tutorials = require('tutorials');\n\nfunction example2() {\n  // Function implementation\n  return tutorials.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 3",
    "code": "# Example 3 for tutorials\nimport tutorials\n\ndef example3():\n    # Function implementation\n    return tutorials.do_something()",
    "language": "python"
  },
  {
    "title": "Example 4",
    "code": "// Example 4 for tutorials\nconst tutorials = require('tutorials');\n\nfunction example4() {\n  // Function implementation\n  return tutorials.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 5",
    "code": "// Example 5 for tutorials\nconst tutorials = require('tutorials');\n\nfunction example5() {\n  // Function implementation\n  return tutorials.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 6",
    "code": "# Example 6 for tutorials\nimport tutorials\n\ndef example6():\n    # Function implementation\n    return tutorials.do_something()",
    "language": "python"
  },
  {
    "title": "Example 7",
    "code": "// Example 7 for tutorials\nconst tutorials = require('tutorials');\n\nfunction example7() {\n  // Function implementation\n  return tutorials.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 8",
    "code": "// Example 8 for tutorials\nconst tutorials = require('tutorials');\n\nfunction example8() {\n  // Function implementation\n  return tutorials.doSomething();\n}",
    "language": "javascript"
  },
  {
    "title": "Example 9",
    "code": "# Example 9 for tutorials\nimport tutorials\n\ndef example9():\n    # Function implementation\n    return tutorials.do_something()",
    "language": "python"
  },
  {
    "title": "Example 10",
    "code": "// Example 10 for tutorials\nconst tutorials = require('tutorials');\n\nfunction example10() {\n  // Function implementation\n  return tutorials.doSomething();\n}",
    "language": "javascript"
  }
];
...
const TOOLS = [
  {
    name: 'search_docs',
    description: 'Search the tutorials documentation',
    parameters: {
      type: 'object',
      properties: {
        query: {
  ...
  },
  {
    ...
    description: 'Get code examples from the tutorials documentation',
    parameters: {
      type: 'object',
      properties: {
        keyword: {
...
app.get('/', (req, res) => {
  res.json({
    name: 'tutorials Documentation Server',
    description: 'An MCP server providing access to tutorials documentation',
    version: '1.0.0',
    protocol: 'mcp',
...
app.listen(PORT, () => {
  console.log(`tutorials Documentation Server running on port ${PORT}`);
});
