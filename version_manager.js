...
async function createVersion() {
  ...
  console.log(`To work with this version, use: node version_manager.js switch ${versionName}`);
}
...
function showHelp() {
  ...
  console.log('\nExample usage:');
  console.log('  node version_manager.js create');
  console.log('  node version_manager.js switch version_2');
  console.log('  node version_manager.js list');
}
